...
CREATE TABLE `tb_usuarios` (
  ...
  `Nom_completo` varchar(25) NOT NULL,
...
INSERT INTO `tb_usuarios` (`idUser`, `NomUser`, `Passwd`,`Nom_completo`, `NiveUser`) VALUES
(1, 'jefeventas', 'unach//..8975423','Sara Roblero Loarca', 2),
(2, 'jefesuc1', 'suc&&//889..','Dr.Christian Mauricio Castillo Estrada', 2),
(3, 'ily24','0903','Iliany Roblero Roblero', 2),
(4, 'edu2003','090322','Eduardo Yahir Lopez Gomez',2);
